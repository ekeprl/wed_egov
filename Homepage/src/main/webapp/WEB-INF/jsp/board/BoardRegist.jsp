...
<script src="https://cdn.tiny.cloud/1/2bkih12pnyjruq5ewphxy9hpaoa4k8fr2n6ybepztakrul3n/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
    ...
    tinymce.init({
        ...
        selector: '#boardCn', //어디에 적용할 지 연결해주는 고리역할
        height: 500,
        menubar: false,
        plugins: plugins,
	...
	<div id="contents">
		<form action="${actionUrl}" method="post" id="frm" name="frm" onsubmit="return regist()" enctype="multipart/form-data">
					...
					<td>
						...
						<tr>
							...
							<tr>
								...
								</td>		<!--연속해서 출력하려면 띄어쓰기를 하지 않는다. (textarea)는붙여써야한다.  -->
							</tr>
			...
			<div class="btn-cont ar">
				<c:choose>
					<c:when test="${not empty searchVO.boardId}">
						<c:url var="uptUrl" value="/board/update.dp">
...
<script>
 $(document).ready(function(){
	...
	function regist() {
		...
		//에디터 내용 저장
		$("#boardCn").val(tinymce.activeEditor.getContent());    //textarea에 저장 + 써줘야 db에 반영이된다
	}
</script>
</body>
</html>
