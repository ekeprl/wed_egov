...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
		...
		// 1. 입력한 비밀번호를 암호화한다.
		String enpassword = EgovFileScrty.encryptPassword(vo.getPassword(), vo.getId()); //password와 id의 순서도 중요하니 알아두자!
		vo.setPassword(enpassword); //sha256으로 만들기위해 encrypt를 사용
